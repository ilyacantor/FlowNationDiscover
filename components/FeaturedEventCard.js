...
export default function FeaturedEventCard({
  ...
  return (
    <a
      ...
      className="block bg-card border border-border rounded-lg overflow-hidden hover-elevate transition-all flex-shrink-0"
      style={{ width: "280px" }}
    ...
    >
      <div className="relative h-40 bg-muted overflow-hidden">
        ...
        <span
          className="absolute top-2 left-2 bg-primary text-primary-foreground px-2 py-1 text-xs font-medium rounded"
